...
define(function() {
  ...
  // Given an ImageElement for the depth image and texture image, return an
  // ImageElement whose contents represent a magic eye picture.
  exports.updateMagicEye = function(depthImg, textureImg) {
